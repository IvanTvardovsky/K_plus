...
class Risk4 extends React.Component{
    ...
    quests = [
        {
            number: 1,
            question: 'FirstQuestion in FourthRisk',
            answer: 'FirstAnswer in FourthRisk',
            ansCheck: false,
            help: false
        },
        {
            number: 2,
            question: 'SecondQuestion in FourthRisk',
            answer: 'SecondAnswer in FourthRisk',
            ansCheck: false,
            help: false
        },
        {
            number: 3,
            question: 'ThirdQuestion in FourthRisk',
            answer: 'ThirdAnswer in FourthRisk',
            ansCheck: false,
            help: false
        }
    ]
