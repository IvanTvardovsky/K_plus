...
class Risk12 extends React.Component {
   ...
   quests = [
      {
         number: 1,
         question: 'Проверили ли Вы доверенность перед покупкой участка?',
         answer: 'Риск есть.',
         ansCheck: false,
         help: false
      }
   ...
   render() {
      ...
      const tooltips = [
         `<b>Доверенность</b> - это документ, который дает право одному человеку действовать от имени другого.`
      ];
      return (
         <div className="Risk">
