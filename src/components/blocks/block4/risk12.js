...
class Risk12 extends React.Component {
   ...
   render() {
      ...
      const tooltips = [
         `<b>Генеральная доверенность</b> - это документ, которые дает право доверенному лицу на самые разные юридические действия, в том числе на покупку или отчуждение имущества и подпись документов.`
      ];
      return (
         <div className="Risk">
