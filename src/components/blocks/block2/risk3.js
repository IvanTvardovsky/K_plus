...
class Risk3 extends React.Component {
   ...
   render() {
      ...
      const tooltips = [
         ...
         `Посмотреть все виды разрешенного использования и их описание можно в Приказе Росреестра от 10.11.2020 N П/0412`,
      ...
      return (
         <div className="Risk">
            <div className="RiskName">
               ...
               />
               <h3>Риск: Целевое использование объекта</h3>
            </div>
