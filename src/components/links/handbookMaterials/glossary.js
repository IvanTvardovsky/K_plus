   ...
   render() {
      return (
         <div>
            ...
            <p className="definition bigger">Это признанная судом неспособность гражданина погасить долги, в результате
               которой
            ...
            <p className="definition bigger">это характеристика земельного участка, которая определяет, что на участке
            ...
            <p className="definition bigger">Это специалист, который подготавливает документы для внесения информации о
            ...
            <p className="definition bigger">Это процесс полного или частичного устранения ограничений или обязательств,
               связанных с недвижимостью или имуществом.</p>

            <h2 className="term">Право собственности</h2>
            <p className="definition bigger">Это право гражданина владеть, пользоваться и распоряжаться имуществом.</p>
            ...
            <p className="definition bigger">Это система учета должников, которая расположена на официальном сайте ФССП
               России.</p>

            <h2 className="term">Справка из наркологического диспансера</h2>
            <p className="definition bigger">Это документ, который подтверждает факт того, что обратившийся не стоит на
            ...
            <p className="definition bigger">Это документ, который подтверждает факт того, что лицо не состоит на учете
               в психоневрологическом диспансере и не имеет психических заболеваний, а также гарантирует невозможность
            ...
            <p className="definition bigger">Это состояние окружающей среды земельного участка, включая наличие полезных
            ...
            <p className="definition bigger">Это криминальное явление, направленное против основ конституционного строя
               и
