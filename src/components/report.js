                                    ...
                                    {answers.first.risk1.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             ...
                                             <Text style={styles.text}>Есть риск претензий со стороны супруга Продавца,
                                                поэтому: </Text>
                                             <Text style={styles.text}>Необходимо уточнить наличие брачного договора
                                                между супругами.
                                             ...
                                             <Text style={styles.text}>Необходимо выяснить, когда земельный участок был
                                                приобретен
                                             ...
                                             <Text style={styles.text}>Ознакомиться с законодательством вы можете по
                                                ссылке (ч. 1 ст. 256 ГК РФ): </Text>
                                             <Link
                                                src='https://www.consultant.ru/document/cons_doc_LAW_5142/ec0c88d23cfe0b75563d574872c1457827b3607f/?ysclid=lkb23oaxga358628244'
                                                style={{
                                                   fontSize: '12px',
                                                }}>
                                                ГК РФ Статья 256. Общая собственность супругов \ КонсультантПлюс
                                             </Link>
                                             <Text style={styles.text}>Попросите Продавца обратиться к нотариусу для
                                                получения
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.first.risk10.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Право собственности Продавца на землю не
                                                проверено, поэтому: </Text>
                                             <Text style={styles.text}>Запросите у Продавца подтверждение права
                                             ...
                                             <Text style={styles.text}>На любой зарегистрированный объект недвижимости
                                                можно получить
                                                выписку из ЕГРН, даже если у собственника ее никогда не было.<br/>
                                                Ознакомиться с законодательством Вы можете по ссылке(ст. 62 ГК
                                                РФ):</Text>
                                             <Link
                                                src='https://www.consultant.ru/document/cons_doc_LAW_182661/e064cc95b1bdffa4d12abb92fdfc56dea94198df/'
                                                style={{
                                                   fontSize: '12px',
                                                }}>
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.first.risk12.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск, что генеральная доверенность не
                                                является достоверной,
                                                поэтому: </Text>
                                             <Text style={styles.text}>Проверьте генеральную доверенность по
                                                ссылке: </Text>
                                    ...
                                    {answers.second.risk2.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          {answers.second.risk2.number === 1 ? (
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}>Есть риск, что межевание не проведено,
                                                   поэтому: </Text>
                                                <Text style={styles.text}>Необходимо провести межевание земельного
                                                   участка и поставить
                                                   его на кадастровый учет. Попросите Продавца воспользоваться
                                                   услугами кадастрового инженера. Он поможет провести проверку
                                                   межевания. </Text>
                                                <Text style={styles.text}>Аккредитованные кадастровые инженеры есть в
                                                   реестре. </Text>
                                                <Text style={styles.text}>Ознакомиться с ним Вы можете по
                                                   ссылке: </Text>
                                             ...
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}>Есть риск, что межевание не соответствует
                                                   выписке ЕГРН,
                                                   поэтому: </Text>
                                                <Text style={styles.text}>Проверьте межевой план и акт согласования
                                                   границ с помощью
                                                ...
                                                <Text style={styles.text}>Воспользуйтесь услугами кадастрового инженера.
                                                   Он поможет Вам
                                          ...
                                          {answers.second.risk3.number === 1 ? (
                                             ...
                                             <View>
                                                {answers.second.risk3.number === 2 ? (
                                                   ...
                                                   <View style={styles.Rec}>
                                                      <Text style={styles.recTitle}>Рекомендации:</Text>
                                                      <Text style={styles.text}>Есть риск, что объект попадает в зону
                                                         особого
                                                         назначения, поэтому: </Text>
                                                      <Text style={styles.text}>Проверьте информацию по земельному
                                                         участку на портале
                                                         ФГИС ТП по ссылке:
                                                      </Text>
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.second.risk4.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск того, что Вы не проинформированы об
                                                экологической ситуации
                                                земельного участка, поэтому: </Text>
                                             <Text style={styles.text}>Запросите информацию об экологической ситуации по
                                                ссылке:
                                             </Text>
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.second.risk8.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск того, что Вы не проинформированы о
                                                юридической истории
                                                земельного участка, поэтому: </Text>
                                             <Text style={styles.text}>Ознакомьтесь с информацией о переходе прав на
                                                объект недвижимости,
                                    ...
                                    {answers.second.risk11.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          {answers.second.risk11.number === 1 ? (
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}>Есть риск, что Вы не ознакомлены с возможными
                                                   обременениями на
                                                   земельный участок, поэтому: </Text>
                                                <Text style={styles.text}>Узнайте информацию о наличии обременений на
                                                   участок можно
                                                   тремя способами: <br/>
                                                ...
                                                <Text style={styles.text}>Для осуществления запроса, достаточно иметь
                                                   кадастровый
                                             ...
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}> Есть риск, что Продавец откажется погасить
                                                   обременения,
                                                   поэтому: </Text>
                                                <Text style={styles.text}> Предложите включить условие в договор о
                                                   погашении обременений
                                                   продавцом. </Text>
                                             </View>
                                          )}
                                       </View>
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.third.risk5.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск, что Продавец является банкротом,
                                                поэтому: </Text>
                                             <Text style={styles.text}>Проверьте наличие Продавца в списках банкротов в
                                                соотвествующем
                                                реестре:</Text>
                                             <Link
                                                src='https://old.bankrot.fedresurs.ru/?ysclid=ljpmeb4npx361137021&attempt=2'
                                                style={{
                                                   fontSize: '12px',
                                                }}>
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.third.risk7.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск, что Продавец причастен к экстремизму
                                                или иным
                                                преступлениям, поэтому: </Text>
                                             <Text style={styles.text}>Проверьте Продавца в соответствующем реестре лиц,
                                                причастных к
                                                экстремизму:</Text>
                                             <Link
                                                src='https://www.fedsfm.ru/documents/terr-list?ysclid=ljpmkslzio263245615'
                                                style={{
                                                   fontSize: '12px',
                                                }}>
                                                https://www.fedsfm.ru/documents/terr-list?ysclid=ljpmkslzio263245615
                                             </Link>
                                             <Text style={styles.text}>Наличие иных преступлений продавца можно
                                                проверить в сервисе МВД
                              ...
                              {answers.third.risk9.cat > -1 && (
                                 <View style={styles.riskBlock}>
                                    {answers.third.risk9.cat === 0 ? (
                                       ...
                                       <View>
                                          <View style={styles.RiskNameOrange}>
                                             <Text style={styles.textRisk}>Риск: Продавец-ответчик в судебном
                                                споре</Text>
                                             <Text style={[styles.textRisk, {textAlign: 'right'}]}>Риск есть</Text>
                                          </View>
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск, что Продавец участвует в судебном
                                 ...
                                 <View style={styles.riskBlock}>
                                    {answers.third.risk13.q1.cat === 0 ? (
                                       ...
                                       <View>
                                          ...
                                          <View style={styles.Rec}>
                                             <Text style={styles.recTitle}>Рекомендации:</Text>
                                             <Text style={styles.text}>Есть риск, что Продавец является недееспособным,
                                                поэтому:</Text>
                                             <Text style={styles.text}>Получите выписку из ЕГРН о признании
                                                правообладателя недееспособным
                                             ...
                                             <Text style={styles.text}>Запросите у Продавца справки из
                                    ...
                                    <View style={styles.riskBlock}>
                                       {answers.first.risk1.cat === 0 ? (
                                          ...
                                          <View>
                                             ...
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}>Есть риск претензий со стороны супруга
                                                   Продавца, поэтому: </Text>
                                                <Text style={styles.text}>Необходимо уточнить наличие брачного договора
                                                   между супругами.
                                                   Нотариальное согласие второго супруга не требуется в случае, если
                                                   заключен брачный договор, в котором прописано условие о праве
                                                   распоряжения земельным участком. </Text>
                                                <Text style={styles.text}>Необходимо выяснить, когда земельный участок
                                                   был приобретен
                                                   продавцом. Если до брака путем личного приобретения, дарения или
                                                   наследства, то второй супруг не может препятствовать совершению
                                                   сделки; если в браке, то второй супруг должен выразить свое согласие
                                          ...
                                          <View>
                                             ...
                                             <View style={styles.Rec}>
                                                ...
                                                <Text style={styles.text}>Запросите у Продавца подтверждение права
                                                   ...
                                                   ЕГРН; <br/>
                                                   15.07.2016 - по настоящее время - только выписка из ЕГРН. </Text>
                                                <Text style={styles.text}>На любой зарегистрированный объект
                                                   недвижимости можно получить
                                                   выписку из ЕГРН, даже если у собственника ее никогда не было.<br/>
                                                   Ознакомиться с законодательством Вы можете по ссылке(ст. 62 ГК
                                                   РФ):</Text>
                                                <Link
                                          ...
                                          <View>
                                             ...
                                             {answers.second.risk2.number === 1 ? (
                                                ...
                                                <View style={styles.Rec}>
                                                   ...
                                                   <Text style={styles.text}>Воспользуйтесь услугами кадастрового
                                                      инженера. Он поможет Вам
                                                      провести проверку межевания. </Text>
                                                </View>
                                             )}
                                          </View>
                                          ...
                                          <View>
                                             ...
                                             <View style={styles.Rec}>
                                                ...
                                                <Text style={styles.text}>Есть риск того, что Вы не проинформированы об
                                                   экологической ситуации
                                                   земельного участка, поэтому: </Text>
                                                <Text style={styles.text}>Запросите информацию об экологической ситуации
                                                   по ссылке:
                                                </Text>
                                                <Link src='https://www.gosuslugi.ru/72281/1/info'
                                                      style={{
                                       ...
                                       {answers.second.risk11.cat === 0 ? (
                                          ...
                                          <View>
                                             ...
                                             {answers.second.risk11.number === 1 ? (
                                                <View style={styles.Rec}>
                                                   <Text style={styles.recTitle}>Рекомендации:</Text>
                                                   <Text style={styles.text}>Есть риск, что Вы не ознакомлены с
                                                      возможными обременениями на
                                                      земельный участок, поэтому: </Text>
                                                   <Text style={styles.text}>Узнайте информацию о наличии обременений на
                                                      участок можно
                                                      тремя способами: <br/>
                                       ...
                                       {answers.third.risk5.cat === 0 ? (
                                          ...
                                          <View>
                                             ...
                                             <View style={styles.Rec}>
                                                ...
                                                <Text style={styles.text}>Есть риск, что Продавец является банкротом,
                                                   поэтому: </Text>
                                                <Text style={styles.text}>Проверьте наличие Продавца в списках банкротов
                                                   в соотвествующем
                                                   реестре:</Text>
                                                <Link
                                                   src='https://old.bankrot.fedresurs.ru/?ysclid=ljpmeb4npx361137021&attempt=2'
                                    ...
                                    <View style={styles.riskBlock}>
                                       {answers.third.risk7.cat === 0 ? (
                                          ...
                                          <View>
                                             ...
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}>Есть риск, что Продавец причастен к
                                                   экстремизму или иным
                                                   преступлениям, поэтому: </Text>
                                    ...
                                    <View style={styles.riskBlock}>
                                       {answers.third.risk13.q1.cat === 0 ? (
                                          ...
                                          <View>
                                             ...
                                             <View style={styles.Rec}>
                                                <Text style={styles.recTitle}>Рекомендации:</Text>
                                                <Text style={styles.text}>Есть риск, что Продавец является
                                                   недееспособным, поэтому:</Text>
                                                <Text style={styles.text}>Получите выписку из ЕГРН о признании
                                                   правообладателя недееспособным
                                                   или ограниченно дееспособным. Инструкция по ссылке: </Text>
                                                <Link src='https://www.gosuslugi.ru/help/faq/egrn/101769'
