                  ...
                  {((answers.first.risk1.cat < 1) && (answers.first.risk10.cat < 1) && (answers.second.risk2.cat < 1) && (answers.second.risk3.cat < 1)
                     ...
                     <div>
                        {((answers.first.risk1.cat === 0) && (answers.first.risk10.cat === 0) && (answers.second.risk2.cat === 0) && (answers.second.risk3.cat === 0)
                           ...
                           <div>
                              <h2 style={{marginLeft: "3%"}}>Исходя из ваших ответов, риски не обнаружены, сделка может быть заключена. </h2>
                              ...
                              <p className="warning">Информируем Вас, что вся представленная информация на сайте является справочной, команда “ЗемельКа” не оказывает влияние на 
                              принятие Вами итогового решения по заключению сделки и не несет юридическую ответственность за это.</p>
                           ...
                           <div>
                              ...
                              <p className="warning">Информируем Вас, что вся представленная информация на сайте является справочной, команда “ЗемельКа”
                               не оказывает влияние на принятие Вами итогового решения по заключению сделки и не несет юридическую ответственность за это.</p>
                              <div className="warning">
                                 Вся информация актуальна на {currentDate}
                              </div>
                           </div>
                     ...
                     <div>
                        ...
                        && (answers.third.risk13.q1.cat < 2) && (answers.third.risk13.q2.cat < 2)) ? (
                           <h2 style={{marginLeft: "3%"}}>Исходя из ваших ответов, риски обнаружены, но сделка может заключена.</h2>
                        ) : (
                           <h2 style={{marginLeft: "3%"}}>Исходя из ваших ответов, риски обнаружены, сделка не может быть заключена.</h2>
                        )}
                        {((answers.first.risk1.cat > -1) && (answers.first.risk10.cat > -1) && (answers.second.risk2.cat > -1) && (answers.second.risk3.cat > -1)
                           && (answers.second.risk4.cat > -1) && (answers.second.risk8.cat > -1) && (answers.second.risk11.cat > -1) && (answers.third.risk5.cat > -1)
                           && (answers.third.risk6.cat > -1) && (answers.third.risk7.cat > -1) && (answers.third.risk9.cat > -1) && (answers.first.risk12.cat > -1)
