                                ...
                                <div>
                                    ...
                                    && (answers.fourth.risk13.q1.cat > -1) && (answers.fourth.risk13.q2.cat > -1)) ? (
                                        <div>
                                                        ...
                                                        {answers.first.risk1.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    ...
                                                                    <p> Необходимо уточнить наличие брачного договора между супругами. Нотариальное согласие второго супруга не требуется в случае, если заключен брачный договор. </p>
                                                                    <p> Необходимо выяснить, когда земельный участок был приобретен продавцом. Если до брака путем личного приобретения, дарения или наследства, то второй супруг не может препятствовать совершению сделки; если в браке, то второй супруг должен выразить свое согласие на продажу, которое будет нотариально заверено. </p>
                                                                    <p> Попросите Продавца обратиться к нотариусу для получения нотариального согласия. <br />
                                                                    Записаться на прием к нотариусу можно на Госуслугах по ссылке: https://www.gosuslugi.ru/help/faq/notary/102751 </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                        ...
                                                        {answers.first.risk10.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    ...
                                                                    <p> Запросите у Продавца подтверждение права собственности на объект. Это могут быть разные документы в зависимости от года регистрации: <br />
                                                                    21.01.1998 - 01.09.2013 - свидетельство о регистрации права собственности; <br />
                                                                    01.09.2013 - 15.07.2016 - свидетельство о регистрации или выпиской из ЕГРН; <br />
                                                                    15.07.2016 - по настоящее время - только выписка из ЕГРН.  </p>
                                                                    <p> На любой зарегистрированный объект недвижимости можно получить выписку из ЕГРН, даже если у собственника ее никогда не было. Заказать ее Вы можете, перейдя по ссылке: https://rosreestor.net/vipiska-o-perehode-prav</p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                                ...
                                                                {answers.second.risk2.number === 1 ? (
                                                                    <div>
                                                                        <div className="Rec">
                                                                            ...
                                                                            <p> Необходимо провести межевание земельного участка и поставить его на кадастровый учет. </p>
                                                                        </div>
                                                                    </div>
                                                                ) : (
                                                                    <div>
                                                                        <div className="Rec">
                                                                            <h3>Рекомендации:</h3>
                                                                            <p> Есть риск, что межевание не соответствует выписке ЕГРН, поэтому: </p>
                                                                            <p> Проверьте с помощью публичной кадастровой карты Росреестра: <br />
                                                                            Сылка №1 https://www.gosuslugi.ru/378659/1/info <br />
                                                                            Ссылка № 2 https://pkk.rosreestr.ru/?source=subscribe#/search/63.60201437832657,65.56074746184491/4/@bzbws4844 </p>
                                                                            <p> Воспользуйтесь услугами кадастрового инженера. Он поможет Вам провести проверку межевания. </p>
                                                                        </div>
                                                                    </div>
                                                                )}
                                                            </div>
                                                                    ...
                                                                    <div>
                                                                        {answers.second.risk3.number === 2 ? (
                                                                            <div>
                                                                                <div className="Rec">
                                                                                    <h3>Рекомендации:</h3>
                                                                                    <p> Запросите Продавца предоставить официально подтвержденную информацию. </p>
                                                                                </div>
                                                                            </div>
                                                                        ) : (
                                                                            <div>
                                                                                <div className="Rec">
                                                                                    <h3>Рекомендации:</h3>
                                                                                    <p> Есть риск, что объект попадает в зону особого назначения, поэтому: </p>
                                                                                    <p> Проверьте с помощью публичной кадастровой карты Росреестра. <br />
                                                                                    Ссылка № 1: https://www.gosuslugi.ru/378659/1/info <br />
                                                                                    Ссылка № 2: https://pkk.rosreestr.ru/?source=subscribe#/search/63.60201437832657,65.56074746184491/4/@bzbws4844</p> 
                                                                                    <p> Проверьте генеральный план развития местности, утвержденный местной администрацией. Например, Генплан Москвы до 2035 г. можно посмотреть по ссылке: https://genplanmos.ru/project/generalnyy_plan_moskvy_do_2035_goda/ </p>
                                                                                    <p> Проверьте Правила землепользования и застройки. Например, Правила землепользования и застройки города Москвы можно посмотреть по ссылке: https://www.mos.ru/mka/documents/pravila-zemlepolzovaniya-i-zastrojki-goroda-moskvy/</p>
                                                                                    <p> Проверьте информацию по земельному участку на портале ФГИС ТП по ссылке: https://fgistp.economy.gov.ru/ </p>
                                                                                </div>
                                                                            </div>
                                                                        )}
                                                                    </div>
                                                    ...
                                                    <div>
                                                        {answers.second.risk4.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    <h3>Рекомендации:</h3>
                                                                    <p>Есть риск того, что Вы не проинформированы об экологической ситуации земельного участка, поэтому: </p>
                                                                    <p>Запросите информацию об экологической ситуации по ссылке: https://www.gosuslugi.ru/72281/1/info</p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div>
                                                        {answers.second.risk8.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    <h3>Рекомендации:</h3>
                                                                    <p> Есть риск того, что Вы не проинформированы о юридической истории земельного участка, поэтому: </p>
                                                                    <p> Ознакомьтесь с информацией о переходе прав на объект недвижимости, заказав выписку из ЕГРН по ссылке: https://rosreestor.net/vipiska-o-perehode-prav </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                {answers.second.risk11.number === 1 ? (
                                                                    <div>
                                                                        <div className="Rec">
                                                                            <h3>Рекомендации:</h3>
                                                                            <p> Есть риск, что Вы не ознакомлены с возможными обременениями на земельный участок, поэтому: </p>
                                                                            <p> Узнайте информацию о наличии обременений на участок можно тремя способами: <br />
                                                                            1) сделать запрос через МФЦ (Мои документы); <br />
                                                                            2) обратиться в территориальный орган надзора за недвижимостью, в ведении которого находится интересующая недвижимость; <br />
                                                                            3) воспользоваться личным кабинетом на сайте государственных услуг ( gosuslugi.ru ) и подать заявление; </p>
                                                                            <p> Для осуществления запроса, достаточно иметь кадастровый паспорт или номер участка и его местоположение. По итогам обращения, Вам выдается выписка 
                                                                                с полным перечнем всех сведений об интересующем объекте, включая типы наложенных арестов, обременений и иных ограничений.</p>
                                                                        </div>
                                                                    </div>
                                                                ) : (
                                                                    <div>
                                                                        <div className="Rec">
                                                                            <h3>Рекомендации:</h3>
                                                                            <p> Есть риск, что Продавец откажется погасить обременения, поэтому: </p>
                                                                            <p> Предложите включить условие в договор о погашении обременений продавцом. </p>
                                                                        </div>
                                                                    </div>
                                                                )}
                                                            </div>
                                                        ...
                                                        {answers.third.risk5.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    ...
                                                                    <p> Проверьте наличие Продавца в списках банкротов в соотвествующем реестре: https://old.bankrot.fedresurs.ru/?ysclid=ljpmeb4npx361137021&attempt=2 </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                        ...
                                                        {answers.third.risk6.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    ...
                                                                    <p> Проверьте Продавца в соответствующем реестре: https://fssp.gov.ru/ </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div>
                                                        {answers.third.risk7.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    <h3>Рекомендации:</h3>
                                                                    <p> Есть риск, что Продавец причастен к экстремизму или иным преступлениям, поэтому: </p>
                                                                    <p> Проверьте Продавца в соответствующем реестре лиц, причастных к экстремизму: https://www.fedsfm.ru/documents/terr-list?ysclid=ljpmkslzio263245615 </p>
                                                                    <p> Наличие иных преступлений продавца можно проверить в сервисе МВД "Внимание, розыск!": https://мвд.рф/wanted </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div>
                                                        {answers.third.risk9.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    <h3>Рекомендации:</h3>
                                                                    <p> Есть риск, что Продавец участвует в судебном производстве в качестве ответчика, поэтому: </p>
                                                                    <p> Проверьте продавца в соответствующем реестре: https://mos-gorsud.ru/mgs/services/cases/first-civil. <br />
                                                                    Это нужно для того, чтобы удостовериться, что в отношении продавца нет возбужденных судебных дел, которые бы могли угрожать совершению сделки (например, развод). </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div>
                                                        {answers.fourth.risk12.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    <h3>Рекомендации:</h3>
                                                                    <p> Есть риск, что генеральная доверенность не является достоверной, поэтому: </p>
                                                                    <p> Проверьте генеральную доверенность по ссылке: https://reestr-dover.ru/ </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                                        ...
                                                        {answers.fourth.risk13.q1.cat === 0 ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="Rec">
                                                                    ...
                                                                    <p> Получите выписку из ЕГРН о признании правообладателя недееспособным или ограниченно дееспособным. 
                                                                        Инструкция по ссылке: https://www.gosuslugi.ru/help/faq/egrn/101769 </p>
                                                                    <p> Запросите у Продавца справку из ПНД, чтобы удостовериться в его полной дееспособности. </p>
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                            ...
                                            <div>
                                                <h2>Рекомендуем для более подробного ознакомления с рисками перейти в раздел справочник!</h2>
                                            </div>
                                        </div>
                                    ) : (
                                        <div>
