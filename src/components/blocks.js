            ...
            <div className="Blocks">
                {reportClick ? (
                    ...
                    <div>
                                ...
                                <div>
                                    {answers.first.risk1.cat === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="Rec">
                                                <h3>Рекомендации:</h3>
                                                <p>Попросите Продавца обратиться к нотариусу для получения нотариального согласия. </p>
                                                <p> Записаться на прием к нотариусу можно на Госуслугах по ссылке: https://www.gosuslugi.ru/help/faq/notary/102751</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                                ...
                                                <div>
                                                    <div className="Rec">
                                                        ...
                                                        <p> Кадастровый инженер поможет Вам провести проверку межевания. <br />
                                                             Проверьте градостроительного плана участка. О порядке получения смотреть по ссылке: https://www.gosuslugi.ru/53918/3/info <br />
                                                    ...
                                                    {answers.second.risk3.number === 2 ? (
                                                        ...
                                                        <div>
                                                            <div className="Rec">
                                                                ...
                                                                <p> Ссылка № 2: https://pkk.rosreestr.ru/?source=subscribe#/search/63.60201437832657,65.56074746184491/4/@bzbws4844 <br />
                                                                    Проверьте генеральный план развития местности, утвержденный местной администрацией. <br />
                                                                    Например, Генплан Москвы до 2035 г. можно посмотреть по ссылке: https://genplanmos.ru/project/generalnyy_plan_moskvy_do_2035_goda/ </p>
                                                                <p> Проверьте Правила землепользования и застройки. Например, Правила землепользования и застройки города Москвы можно посмотреть по ссылке: <br />
                                                                    https://www.mos.ru/mka/documents/pravila-zemlepolzovaniya-i-zastrojki-goroda-moskvy/ </p>
                                                                <p> Проверьте информацию по земельному участку на портале ФГИС ТП по ссылке: https://fgistp.economy.gov.ru/
                                                                    </p>
                                                            </div>
                                                        </div>
                                                    )}
                                ...
                                <div>
                                    {answers.second.risk4.cat === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="Rec">
                                                <h3>Рекомендации:</h3>
                                                <p> Проверьте генеральный план развития местности, утвержденный местной администрацией. <br />
                                ...
                                <div>
                                    {answers.second.risk8.cat === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="Rec">
                                                <h3>Рекомендации:</h3>
                                                <p> Ознакомьтесь с выпиской из ЕГРН о переходе прав  по ссылке: https://rosreestor.net/vipiska-o-perehode-prav </p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                        ...
                                        <div>
                                            ...
                                            {answers.second.risk11.number === 1 ? (
                                                <div>
                                                    <div className="Rec">
                                                        <h3>Рекомендации:</h3>
                                                        <p> Ознакомьтесь с зарегистрированными правами и возможными ограничениями на объект по выписке из ЕГРН </p>
                                                        <p> Запросите актуальную выписку из ЕГРН с обновленной информацией по объекту перед подписанием договора.</p>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div>
                                ...
                                <div>
                                    {answers.third.risk9.cat === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="Rec">
                                                <h3>Рекомендации:</h3>
                                                <p> Проверьте продавца в соответствующем реестре: https://mos-gorsud.ru/mgs/services/cases/first-civil </p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                        ...
                        <div>
                            <h2> Риск №13: Невозможность самостоятельного принятия решения Продавцом. Принуждение к совершению сделки. Часть 1. </h2>
                                ...
                                <div>
                                    {answers.fourth.risk13.q1.cat === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="Rec">
                                                <h3>Рекомендации:</h3>
                                                <p> Получите выписку из ЕГРН о признании правообладателя недееспособным или ограниченно дееспособным. <br />
                                                    Инструция по ссылке: https://www.gosuslugi.ru/help/faq/egrn/101769</p>
                                                <p> Нотариус обеспечит удостоверение договора.  Записаться на прием к нотариусу можно на Госуслугах по ссылке: https://www.gosuslugi.ru/help/faq/notary/102751</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                        ...
                        <div>
                            <h2> Риск №13: Невозможность самостоятельного принятия решения Продавцом. Принуждение к совершению сделки. Часть 2 </h2>
                                ...
                                <div>
                                    {answers.fourth.risk13.q2.cat === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="Rec">
                                                <h3>Рекомендации:</h3>
                                                <p> Нотариус объяснит, что означает сделка и проверит ее соответствие закону. Записаться на прием к нотариусу можно на Госуслугах <br />
